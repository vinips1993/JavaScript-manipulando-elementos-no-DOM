...
const iniciaOuPausaBtIcone = document.querySelector('.app__card-primary-button-icon')
...
function iniciarOuPausar () { 
    ...
    iniciaOuPausaBtIcone.setAttribute('src', `imagens/pause.png`)
}

function zerar (){
    clearInterval(intervalodId)
    iniciarOuPausarBt.innerHTML = "<strong>Começar</strong>"
    iniciaOuPausaBtIcone.setAttribute('src',`imagens/play_arrow.png`)
    intervalodId = null
}
